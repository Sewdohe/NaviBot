...
navi.register_config("reaction_roles", {
    { key = "channel_id", name = "Menu Channel", description = "The channel to spawn the role menu in", type = "channel", default = "" },
    { key = "role_1_name", name = "Role 1 Name", description = "The name shown in the dropdown", type = "string", default = "Announcements" },
    { key = "role_1_id", name = "Role 1 ID", description = "The actual Discord Role ID", type = "role", default = "" },
    { key = "role_2_name", name = "Role 2 Name", description = "The name shown in the dropdown", type = "string", default = "Events" },
    { key = "role_2_id", name = "Role 2 ID", description = "The actual Discord Role ID", type = "role", default = "" },
})

-- 2. Slash Command to Spawn the Menu
navi.create_slash("spawn_roles", "Spawns the self-assign role menu", {}, function(ctx)
        ...
        components = {
            {
                ...
                options = {
                    { label = r1_name, value = "role_1", description = "Click to receive " .. r1_name, emoji = "✨" },
                    { label = r2_name, value = "role_2", description = "Click to receive " .. r2_name, emoji = "🔥" }
                }
            }
        }
    })
